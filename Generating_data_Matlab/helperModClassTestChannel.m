...
%
%   1) Add Rician and Reyleigh multipath fading to input, X, based on PathDelays,
...
%   Copyright 2018 The MathWorks, Inc.
  ...
  properties
    ...
    %  to choose Rayleigh or Rician channel
    UseRayleighChannel = false
  ...
  methods(Access = protected)
    ...
    function out = addMultipathFading(obj, in)
      %addMultipathFading Add Rician or Rayleigh multipath fading
